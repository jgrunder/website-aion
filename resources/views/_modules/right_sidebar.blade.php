...
@if(Config::get('aion.vote.activated'))
    <div class="bloc_with_header bloc_vote">
      <div class="bloc_header">
        ...
        @endif
        <p>1 vote = <span class="strong">{{(!Config::get('aion.vote.boost')) ? Config::get('aion.vote.shop_points_per_vote') : Config::get('aion.vote.shop_points_per_vote') + Config::get('aion.vote.boost_value')}} Points's Shop</span></p>
      </div>
